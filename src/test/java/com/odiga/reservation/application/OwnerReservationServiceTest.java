...
class OwnerReservationServiceTest {
    ...
    @InjectMocks
    OwnerReservationService ownerReservationService;
    ...
    void addReservationSlotTest() {
        ...
        List<ReservationSlotInfoDto> result = ownerReservationService.addAvailableReservationTime(owner, storeId, requestDto);
